    ...
    <div class="row dashboard-nowrap">
        ...
        <div class="m-4 p-3 width-medium text-color-darker">
            <div class="dashboard-content border-dashed p-3 m-4 view-height">
                ...
                <form action="<c:url value="/app/recipe/add/copy"/>" method="post">
                    <input type="hidden" name="recipeId" value="${recipe.ID}" >
                    <div class="mt-4 ml-4 mr-4">
                        <div class="row border-bottom border-3">
                            <div class="col"><h3 class="color-header text-uppercase">Pobierz przepis: ${recipe.name}</h3></div>
                            <div class="col d-flex justify-content-end mb-2">
                                <button type="submit" class="btn btn-color rounded-0 pt-0 pb-0 pr-4 pl-4">Dodaj do swoich przepisów
                                </button>
                            </div>
                        </div>
                        ...
                        <table class="table borderless">
                            ...
                            <tr class="d-flex">
                                ...
                                <td class="col-7">
                                    ...
                                    <input name="name" id="name" class="w-100 p-1" value="${recipe.name}" readonly>
                                </td>
                            </tr>
                            <tr class="d-flex">
                        ...
                        <div class="row d-flex">
                            <div class="col-5 p-4">
                                <textarea name="preparation" id="preparation" class="w-100 p-1" rows="10"
                                          readonly>${recipe.preparation}</textarea>
                            </div>
                            <div class="col-2"></div>

                            <div class="col-5 p-4">
                                <textarea name="ingredients" id="ingredients" class="w-100 p-1" rows="10"
                                          readonly>${recipe.ingredients}</textarea>
                            </div>
                        </div>
                    </div>
                </form>
